...
#
# Module manifest for module 'xFusion-iBMC-Cmdlets'
#
# Generated by: Woo
#
...
Support xFusion server model include: RH1288 V3, RH2288 V3, RH2288H V3, 1288H V5, 2288H V5, 2288 V5, 2488H V5, CH121 V3, CH242 V3, XH622 V3, XH321 V5.'
  ...
  FileList               = @(
    "xFusion-iBMC-Cmdlets.psd1",
    "xFusion-iBMC-Cmdlets.psm1",
    "common/Common.ps1",
  ...
  PrivateData            = @{
    ...
    PSData = @{
      ...
      Tags         = @('xFusion', 'Enterprise', 'iBMC', 'Redfish', 'xFusion-iBMC-Cmdlets')

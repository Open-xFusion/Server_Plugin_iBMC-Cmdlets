...
#>
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $Path = "/Managers/$($RedfishSession.Id)/Actions/Oem/$OEM/Manager.RestoreFactory"
...
#>
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $iBMCIP | Add-Member -MemberType NoteProperty "IPVersion" $Response.Oem.$OEM.IPVersion
      $iBMCIP | Add-Member -MemberType NoteProperty "NetworkPortMode" $Response.Oem.$OEM.NetworkPortMode
      $iBMCIP | Add-Member -MemberType NoteProperty "ManagementNetworkPort" $Response.Oem.$OEM.ManagementNetworkPort

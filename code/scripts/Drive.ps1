  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $DriveLinkList | ForEach-Object {
        ...
        $CleanupOdata = $Drive | Clear-OdataProperties
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $Health = New-Object PSObject -Property @{
        ...
        Summary = $Chassis.Oem.$OEM.DriveSummary.Status;
      }
...
#>
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      if ($null -ne $Payload.Oem -and $null -ne $Payload.Oem.$OEM.SpareforLogicalDrives) {
        $VolumeOdataId = Get-VolumeOdataId $RedfishSession $Payload.Oem.$OEM.SpareforLogicalDrives
        if ($null -ne $VolumeOdataId) {
          $Payload.Oem.$OEM.SpareforLogicalDrives = @(
            @{

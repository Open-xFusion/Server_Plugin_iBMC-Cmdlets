...
#>
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      if ($null -ne $System.Oem.$OEM.ProcessorView) {
        $Path = $System.Oem.$OEM.ProcessorView."@odata.id"
    ...
    $ScriptBlock = {
      ...
      if ($null -ne $System.Oem.$OEM.ProcessorView) {
        ...
        $Members.Members | ForEach-Object {
          ...
          $Status | Add-member Noteproperty "DeviceLocator" $Processor.Oem.$OEM.DeviceLocator

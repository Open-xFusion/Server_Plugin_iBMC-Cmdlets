...
#>
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $Services | Add-Member -MemberType NoteProperty "VNC" $Response.Oem.$OEM.VNC
      $Services | Add-Member -MemberType NoteProperty "Video" $Response.Oem.$OEM.Video
      $Services | Add-Member -MemberType NoteProperty "NAT" $Response.Oem.$OEM.NAT

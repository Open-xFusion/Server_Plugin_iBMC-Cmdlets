  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $Collection.Members | ForEach-Object {
        ...
        $Merged = Merge-OemProperties $Clone $OEM
        ...
        $NetworkPortCollection.Members | ForEach-Object {
          ...
          $CleanupOdata = $NetworkPort | Clear-OdataProperties
  ...
  process {
    ...
    $ScriptBlock = {
      ...
      $Health = New-Object PSObject -Property @{
        ...
        Summary = $Chassis.Oem.$OEM.NetworkAdaptersSummary.Status;
      }
      ...
      $Collection.Members | ForEach-Object {
        ...
        $Status | Add-member Noteproperty "Name" $NetworkAdapter.Oem.$OEM.Name

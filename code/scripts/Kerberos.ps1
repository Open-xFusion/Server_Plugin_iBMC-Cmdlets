...
.PARAMETER Realm
controller domain, Character string, for example, TEST.XFUSION.COM.

.PARAMETER GroupName
Kerberos user group name, Character string

.PARAMETER GroupDomain
Kerberos user group domain, Character string, for example: CN=qwert,OU=admin,DC=xfusion,DC=com

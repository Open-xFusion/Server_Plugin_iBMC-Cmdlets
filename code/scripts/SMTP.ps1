...
PS C:\> Set-iBMCSMTPSetting $session -ServiceEnabled $false -ServerAddress smtp.xfusion.com `
          -TLSEnabled $false -AnonymousLoginEnabled $false `
          -SenderUserName 'xFusion-iBMC' -SenderAddress "powershell@xfusion.com"  -SenderPassword $pwd `

...
<#
.SYNOPSIS
Gets the module details for the xFusion-iBMC-Cmdlets module.
...
Name        : xFusion-iBMC-Cmdlets
Version     : 1.0.1
Path        : C:\Program Files\WindowsPowerShell\Modules\xFusion-iBMC-Cmdlets\xFusion-iBMC-Cmdlets.psm1
Description : xFusion iBMC cmdlets provide cmdlets to quick access iBMC Redfish devices.
...
#>
    ...
    $module = Get-module | Where-Object {$_.Name -eq 'xFusion-iBMC-Cmdlets'}
